"""Spotlight tutorial overlay for first-time SH|RA users."""
...
_STEPS = [
    ...
    },
    {
        ...
        "body": "Click Record and press any key, mouse button, or controller button to set your PTT key. This is how you activate SH|RA.",
        "target": "ptt_edit",
        "tab": 1,
    },
    {
        "title": "Listening Mode",
        "body": "Hold-to-talk keeps SH|RA active while held down. Toggle switches it on and off. Wake word is fully hands-free.",
        "target": "seg_container",
        "tab": 1,
    },
    {
        "title": "You're all set!",
        "body": 'Try saying "show help" or "what can I say" to see everything SH|RA can do.',
        "target": None,
        "tab": 0,
    },
]
