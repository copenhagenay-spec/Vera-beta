"""SH|RA Game Overlay — transparent always-on-top transcript/response display."""
...
class _ExchangeRow(QWidget):
    ...
    def populate(self, you_text: str, shra_text: str, is_current: bool) -> None:
        ...
        shra_style = _SHRA_CURRENT_STYLE if is_current else _SHRA_OLD_STYLE
        self.you.setStyleSheet(you_style)
        self.you.setText(_elide(f"You: {you_text}"))
        self.you.setVisible(True)
        if shra_text:
            self.shra.setStyleSheet(shra_style)
