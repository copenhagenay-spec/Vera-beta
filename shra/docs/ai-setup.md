...
This guide explains how to set up the **"ask \<question\>"** voice command in SH|RA.

---

## How It Works

When you say **"ask \<question\>"**, SH|RA sends your question to an AI provider and reads the answer aloud via text-to-speech. You need an API key from one of the supported providers to use this feature.

---

## Supported Providers

SH|RA automatically detects which provider to use based on your API key — no extra configuration needed.
...
5. Open the SH|RA UI → **Integrations** tab → paste your key into the **API Key** field
6. Click **Save**
...
- SH|RA keeps AI answers short — 2 to 3 sentences maximum
...
- You only need one API key — SH|RA will detect the provider automatically

---

## Troubleshooting

**"SH|RA said it couldn't reach the AI"**
